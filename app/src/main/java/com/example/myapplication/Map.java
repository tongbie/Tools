...
public class Map extends BackAppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(ContextCompat.checkSelfPermission(Map.this, ACCESS_FINE_LOCATION)!= PackageManager.PERMISSION_GRANTED){
            permissionList.add(ACCESS_FINE_LOCATION);
        }
        if(ContextCompat.checkSelfPermission(Map.this, READ_PHONE_STATE)!= PackageManager.PERMISSION_GRANTED){
            permissionList.add(READ_PHONE_STATE);
        }
        if(ContextCompat.checkSelfPermission(Map.this, WRITE_EXTERNAL_STORAGE)!= PackageManager.PERMISSION_GRANTED){
